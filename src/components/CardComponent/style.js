...
const CandInnerWrapper = styled.View` width: ${wp(82)}; flexDirection: row; justifyContent: space-between`
...
export const styles = StyleSheet.create({
    ...
    musicContainer: {
        height: wp(15), backgroundColor: colors.WHITE, borderRadius: wp(3), flexDirection: 'row'
    }
})